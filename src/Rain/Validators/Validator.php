...
class Validator
{
    ...
    public static $builtInValidators = [
        'required' => 'Rain\Validators\RequiredValidator',
        'compare' => 'Rain\Validators\CompareValidator',
        'default' => 'Rain\Validators\DefaultValueValidator',
        'filter' => 'Rain\Validators\FilterValidator',
        'trim' => [
            'class' => 'Rain\Validators\FilterValidator',
            'filter' => 'trim',
            'skipOnArray' => true,
        ],

        'email' => 'Rain\Validators\EmailValidator',
        'match' => 'Rain\Validators\RegularExpressionValidator',
        'string' => 'Rain\Validators\StringValidator',
        'safe' => 'Rain\Validators\SafeValidator',
        'boolean' => 'Rain\Validators\BooleanValidator',
        'in' => 'Rain\Validators\RangeValidator',
        'date' => 'Rain\Validators\DateValidator',
        'url' => 'Rain\Validators\UrlValidator',

        'double' => 'Rain\Validators\NumberValidator',
        'integer' => [
            'class' => 'Rain\Validators\NumberValidator',
            'integerOnly' => true,
        ],
        'number' => 'Rain\Validators\NumberValidator',


        //'captcha' => 'Rain\captcha\CaptchaValidator',
        //'exist' => 'Rain\Validators\ExistValidator',
        //'file' => 'Rain\Validators\FileValidator',
        //'image' => 'Rain\Validators\ImageValidator',
        //'unique' => 'Rain\Validators\UniqueValidator',
    ];
    /**
