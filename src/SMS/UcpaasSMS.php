 ...
 * $sms->accountSid = '7524752fc686217bbbfb78bf6901c999';
 * $sms->token = '4203ea18247cf79a1d06f73ac3ef0888';
 * $sms->appId = "cb1fbb734dad475198e85db04fc90777";
 * $result = $sms->templateSMS(18610089516, 13887, '你好');
 * var_dump($result);
 *
 * http://www.ucpaas.com/
 *
...
class UcpaasSMS
{
     ...
     * @return bool
     */
    public function templateSMS($phone, $templateId, $param)
    {
        //初始化必填
